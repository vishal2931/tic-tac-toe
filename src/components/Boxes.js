...
const Boxes = (props) => {
    ...
    console.log(boxValueData);
    if(boxValueData.length > 0)
    {
        boxValue = boxValueData[0].value;
    }

	const classes = "text-7xl md:text-9xl flex justify-center items-center h-32 md:h-44 lg:h-52 border-white border-4 text-white cursor-pointer " + props.className;
	return (
		<div
			className={classes}
